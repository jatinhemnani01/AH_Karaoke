        ...
        <div class="flex flex-wrap">
          <div class="w-5/6 sm:w-1/2 p-6">
            ...
            <p class="text-gray-600 mb-8">
              Get High Quality Karaoke With Just One Phone Call
            </p>
          </div>
        ...
        <div class="flex flex-wrap flex-col-reverse sm:flex-row">
          ...
          <div class="w-full sm:w-1/2 p-6 mt-6">
            <div class="align-middle">
              ...
              <p class="text-gray-600 mb-8">
                MP3 & MP4 Karaoke Available.. Whatever You Like To Buy
              </p>
            </div>
          </div>
        </div>
        ...
        >
          ...
          >
            ...
            >
              ...
              <ul class="w-full text-center text-sm">
                <li class="text-2xl border-b py-4">₹200</li>
                <li class="text-2xl border-b py-4">$4 USD</li>
                <li class="text-xl border-b py-4">Within 2 Hours</li>
                <li class="text-xl border-b py-4">
                  <a href="tel:+919329023244"
                    ><strong>Call: 9329023244</strong></a
                  >
                </li>
              </ul>
            </div>
          ...
          >
            ...
            >
              ...
              <ul class="w-full text-center text-sm">
                <li class="text-2xl border-b py-4">₹300</li>
                <li class="text-2xl border-b py-4">$5.50 USD</li>
                <li class="text-xl border-b py-4">Within 2 Hours</li>
                <li class="text-xl border-b py-4">
                  <a href="tel:+919329023244"
                    ><strong>Call: 9329023244</strong></a
